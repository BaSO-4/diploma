...
- kje se dejansko pojavita fold in unfold?
...
se uporabijo rekurzivni tipi. V svoji implementaciji sem uporabil iso-recursive pristop, saj je tako lažje obvladovati neskončne vzorce.
...
Za \emph{case} je bilo potrebno dopolniti funkcijo \emph{interp}, da zna poiskati pravo vejo in vrniti njeno posledico. Kot je tuudi navada v splošnem, omogočam vzorec oblike '_', ki 
